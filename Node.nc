...
//NEW
   ...
   event void CommandHandler.ping(uint16_t destination, uint8_t *payload){
      ...
      makePack(&sendPackage, TOS_NODE_ID, destination, MAX_TTL, PROTOCOL_PING, packetNum, payload, PACKET_MAX_PAYLOAD_SIZE);
